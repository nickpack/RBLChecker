...
// --------------------------
define(["jquery", "backbone", "text!templates/results.html", "views/Home","models/Blacklist", "collections/Blacklists", "routers/DesktopRouter", "routers/MobileRouter", "jasminejquery"],
        ...
        describe("RBL Checker", function() {
            ...
            describe("Backbone views", function() {
                ...
                it("should contain the correct view element", function() {
                    ...
                    expect(this.view.$el.selector).toEqual(".results");
